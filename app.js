...
function render() {
  ...
  document.querySelector("#app").innerHTML = `
    <header class="top"><div class="brand"><span class="mark">⌁</span> HARNESS RANGER <em>INTERACTIVE DEMO</em></div><nav class="top-links" aria-label="Demo resources"><a href="docs/cross-judge-validation-and-multi-track-iteration.pdf" target="_blank">Cross-Judge paper (PDF)</a><a href="flow.html">System flow</a></nav><span class="mode">DEMO DATA · NO LIVE CONNECTIONS</span></header>
